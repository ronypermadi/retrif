...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#exportpdf').attr('href', '{{url("/reports/order/pdf")}}'+'/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))
            ...
            $('#created_at').daterangepicker({
                ...
                $('#exportpdf').attr('href', '{{url("/reports/order/pdf")}}'+'/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD'))
            })
        })
    </script>
@endsection()