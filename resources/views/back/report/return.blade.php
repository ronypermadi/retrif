...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#exportpdf').attr('href', '{{url("/reports/return/pdf")}}'+'/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))

            $('#created_at').daterangepicker({
                startDate: start,
                endDate: end
            }, function(first, last) {
                $('#exportpdf').attr('href', '{{url("/reports/return/pdf")}}'+'/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD'))
            })
        })
    </script>
@endsection()